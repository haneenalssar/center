  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          {{--  <a href="#" class="d-block"> {{ auth('admin')->user()->full_name }}</a>  --}}
            ...
            <img src="{{ asset('images/employee/'.auth('employee')->user()->images) }}" class="brand-image img-circle elevation-3" alt="User Image">
            @else
            <img class="brand-image img-circle elevation-3" src="{{ asset('images/userSolid.png') }}"alt="User Image">
            @endif
            ...
            <img src="{{ asset('images/trainer/'.auth('trainer')->user()->images) }}" class="brand-image img-circle elevation-3" alt="User Image">
            @else
            <img class="brand-image img-circle elevation-3" src="{{ asset('images/userSolid.png') }}"alt="User Image">
            @endif
      ...
      <nav class="mt-2">
        ...
        @endCanAny
        @canAny(['Index-Trainer' , 'Create-Trainer'])
        ...
        @canAny(['Index-Vistor' , 'Create-Vistor'])
          ...
          @endCanAny
          @canAny(['Index-Connection','Create-Connection'])
          ...
          @canAny(['Index-Apply','Create-Apply'])
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
          ...
          @endcanany
          @canAny(['Index-Payment','Create-Payment'])
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
        ...
        @endcanany
          @canAny(['Index-Room' , 'Create-Room','Create-TimeLine','Index-TimeLine'])
